...
/** Build a minimal Message for use as a mock response. */
...
describe("Text", () => {
  ...
  describe("create()", () => {
    it("calls requestAnthropic with correct method, path, and body", async () => {
      ...
      mockClient.requestAnthropic.mockResolvedValue(message);
    ...
    it("includes all optional params in the body", async () => {
      mockClient.requestAnthropic.mockResolvedValue(makeMessage());
  ...
  describe("createStream()", () => {
    ...
    it("yields parsed stream events", async () => {
      const messageStart = {
        type: "message_start",
